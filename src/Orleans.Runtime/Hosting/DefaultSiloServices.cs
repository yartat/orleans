        ...
        internal static void AddDefaultServices(HostBuilderContext context, IServiceCollection services)
        {
            ...
            services.TryAddSingleton<IConsistentRingProvider>(
                sp =>
                {
                    ...
                    {
                        return new VirtualBucketsRingProvider(siloDetails.HostSiloAddress ?? siloDetails.SiloAddress, loggerFactory, consistentRingOptions.NumVirtualBucketsConsistentRing);
                    }

                    return new ConsistentRingProvider(siloDetails.HostSiloAddress ?? siloDetails.SiloAddress, loggerFactory);
                });
