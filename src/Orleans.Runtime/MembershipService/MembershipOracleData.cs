...
namespace Orleans.Runtime.MembershipService
{
    internal class MembershipOracleData
    {
        ...
        internal void UpdateMyStatusLocal(SiloStatus status)
        {
            ...
            else if (MyHostAddress != null && tmpLocalTableCopyOnlyActive.ContainsKey(MyHostAddress))
            {
        ...
        {
            return CreateNewMembershipEntry(SiloName, MyHostAddress ?? MyAddress, MyProxyPort, MyHostname, myStatus, SiloStartTime);
        }
