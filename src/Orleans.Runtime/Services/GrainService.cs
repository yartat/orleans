...
namespace Orleans.Runtime
{
    ...
    public abstract class GrainService : SystemTarget, IRingRangeListener, IGrainService
    {
        ...
        protected GrainService(IGrainIdentity grainId, Silo silo, ILoggerFactory loggerFactory) : base((GrainId)grainId, silo.SiloAddress, lowPriority: true, hostSilo: silo.SiloHostAddress, loggerFactory:loggerFactory)
        {
