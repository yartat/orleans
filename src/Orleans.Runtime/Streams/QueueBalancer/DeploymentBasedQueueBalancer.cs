...
namespace Orleans.Streams
{
    ...
    public class DeploymentBasedQueueBalancer : QueueBalancerBase, ISiloStatusListener, IStreamQueueBalancer
    {
            ...
            bool isFixed)
        {
            ...
            foreach (var silo in siloStatusOracle.GetApproximateSiloStatuses(true).Keys.Where(s => !(s.Equals(siloStatusOracle.SiloAddress) || s.Equals(siloStatusOracle.HostSiloAddress))))
            {
