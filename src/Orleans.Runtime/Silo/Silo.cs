...
namespace Orleans.Runtime
{
    ...
    public class Silo
    {
        ...
        private void CreateSystemTargets()
        {
            ...
            typeManager = new TypeManager(SiloAddress, SiloHostAddress, grainTypeManager, membershipOracle, LocalScheduler, GlobalConfig.TypeMapRefreshInterval, implicitStreamSubscriberTable, this.grainFactory, versionDirectorManager,
                this.loggerFactory);
    ...
    internal class ProviderManagerSystemTarget : SystemTarget
    {
        public ProviderManagerSystemTarget(ILocalSiloDetails localSiloDetails, ILoggerFactory loggerFactory)
            : base(Constants.ProviderManagerSystemTargetId, localSiloDetails.SiloAddress, localSiloDetails.HostSiloAddress, loggerFactory)
        {
        }
    }
}
