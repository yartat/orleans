...
namespace Orleans.Runtime.Providers
{
    internal class SiloProviderRuntime : ISiloSideStreamProviderRuntime
    {
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            this.SiloIdentity = (siloDetails.HostSiloAddress ?? siloDetails.SiloAddress).ToLongString();
        ...
        public SiloAddress ExecutingSiloAddress => this.siloStatusOracle.HostSiloAddress ?? this.siloStatusOracle.SiloAddress;
