...
namespace Orleans.Runtime.Configuration
{
    ...
    public class NodeConfiguration :IStatisticsConfiguration
    {
        ...
        public NodeConfiguration()
        {
            ...
            this.HostProxyGatewayEndpoint = null;
        ...
        public NodeConfiguration(NodeConfiguration other)
        {
            ...
            this.HostProxyGatewayEndpoint = other.HostProxyGatewayEndpoint;
        ...
        public override string ToString()
        {
            ...
            {
                sb.Append("   External host endpoint: ").Append(this.HostEndpoint.ToString()).AppendLine();
            }
            ...
            if (this.IsGatewayNode)
            {
                ...
                if (this.HostProxyGatewayEndpoint != null)
                {
                    sb.Append("   External host Proxy Gateway: ").Append(this.HostProxyGatewayEndpoint.ToString()).AppendLine();
                }
            }
            else
            {
            ...
            foreach (XmlNode c in root.ChildNodes)
            {
                ...
                switch (child.LocalName)
                {
                    case "Networking":
                        ...
                        break;
                    case "HostNetworking":
                        this.HostEndpoint = ConfigUtilities.ParseIPEndPoint(child, Subnet).GetResult();
                        break;
                    ...
                    case "HostProxyingGateway":
                        this.HostProxyGatewayEndpoint = ConfigUtilities.ParseIPEndPoint(child, this.Subnet).GetResult();
                        break;
                    case "Scheduler":
