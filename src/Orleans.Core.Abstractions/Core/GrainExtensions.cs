...
namespace Orleans
{
    ...
    public static class GrainExtensions
    {
        ...
        internal static GrainReference AsWeaklyTypedReference(this IAddressable grain)
        {
            ...
            if (systemTarget != null) return GrainReference.FromGrainId(systemTarget.GrainId, systemTarget.GrainReferenceRuntime, null, systemTarget.HostSilo ?? systemTarget.Silo);
