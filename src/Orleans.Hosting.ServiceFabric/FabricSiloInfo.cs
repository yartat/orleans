...
namespace Orleans.ServiceFabric
{
    ...
    public class FabricSiloInfo
    {
        ...
        /// <summary>
        /// Gets the host silo address.
        /// </summary>
        [JsonProperty("hostSilo")]
        public string HostSilo { get; set; }
        ...
        /// </summary>
        [JsonIgnore]
        public SiloAddress HostSiloAddress => string.IsNullOrWhiteSpace(this.HostSilo) ? null : SiloAddress.FromParsableString(this.HostSilo);
